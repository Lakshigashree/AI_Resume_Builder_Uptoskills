    ...
    experience: hasContent("experience") && (
      ...
      >
        ...
        {safeArray(localData.experience).map((exp, i) => (
          <div 
            key={i} 
            style={editMode ? styles.editContainer : { marginBottom: "20px" }}
          >
            {editMode ? (
              <div style={{ display: "grid", gap: "5px" }}>
                <input 
                  ...
                  onChange={(e) => handleArrayFieldUpdate("experience", i, e.target.value, "title")} 
                  placeholder="Job Title" 
                />
                <input 
                  style={styles.input} 
                  value={renderSafe(exp.companyName)} 
                  onChange={(e) => handleArrayFieldUpdate("experience", i, e.target.value, "companyName")} 
                  placeholder="Company Name" 
                />
                <input 
                  style={styles.input} 
                  value={renderSafe(exp.date)} 
                  onChange={(e) => handleArrayFieldUpdate("experience", i, e.target.value, "date")} 
                  placeholder="Duration (e.g. 2020 - 2024)" 
                />
                <textarea 
                  style={{ ...styles.input, minHeight: "100px" }} 
                  value={renderSafe(exp.description)} 
                  onChange={(e) => handleArrayFieldUpdate("experience", i, e.target.value, "description")} 
    ...
    education: hasContent("education") && (
      ...
      >
        ...
        {safeArray(localData.education).map((edu, i) => (
          <div 
            key={i} 
            style={editMode ? styles.editContainer : { marginBottom: "15px" }}
          >
            {editMode ? (
              <div style={{ display: "grid", gap: "5px" }}>
                <input 
                  ...
                  onChange={(e) => handleArrayFieldUpdate("education", i, e.target.value, "degree")} 
                  placeholder="Degree" 
                />
                <input 
                  style={styles.input} 
                  value={renderSafe(edu.institution)} 
                  onChange={(e) => handleArrayFieldUpdate("education", i, e.target.value, "institution")} 
                  placeholder="Institution" 
                />
                <input 
                  style={styles.input} 
                  value={renderSafe(edu.duration)} 
                  onChange={(e) => handleArrayFieldUpdate("education", i, e.target.value, "duration")} 
            ...
            {editMode ? (
              <div style={{ display: "grid", gap: "5px" }}>
                <input 
                  ...
                  onChange={(e) => handleArrayFieldUpdate("projects", i, e.target.value, "name")} 
                  placeholder="Project Name" 
                />
                <textarea 
                  style={styles.input} 
                  value={renderSafe(proj.description)} 
                  onChange={(e) => handleArrayFieldUpdate("projects", i, e.target.value, "description")} 
                  placeholder="Detailed Project Description" 
                />
                <input 
                  style={styles.input} 
                  value={renderSafe(proj.link)} 
                  onChange={(e) => handleArrayFieldUpdate("projects", i, e.target.value, "link")} 
    ...
    certifications: hasContent("certifications") && (
      ...
      >
        ...
        {safeArray(localData.certifications).map((cert, i) => (
          <div 
            key={i} 
            style={editMode ? styles.editContainer : { marginBottom: "8px" }}
          >
            {editMode ? (
              <div style={{ display: "grid", gap: "5px" }}>
                <input 
                  ...
                  onChange={(e) => handleArrayFieldUpdate("certifications", i, e.target.value, "title")} 
      ...
      >
        ...
        <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
          {safeArray(localData.achievements).map((ach, i) => (
            <li 
              key={i} 
              style={editMode ? {listStyle: "none"} : { marginBottom: "8px" }}
            >
              {editMode ? (
                <div style={styles.editContainer}>
                  <input 
                    ...
                    onChange={(e) => handleArrayFieldUpdate("achievements", i, e.target.value)} 
                  />
                  <button 
      ...
      >
        ...
        {editMode ? (
          <input 
            ...
            style={styles.input} 
            placeholder="Chess, Music, Travel..."
          />
        ) : (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  {editMode ? (
                    ...
                    <a href={`tel:${localData.phone}`} style={{textDecoration: "none", color: "#4b5563"}}>{localData.phone}</a>
                  )}
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  {editMode ? (
                    ...
                    <a href={`mailto:${localData.email}`} style={{textDecoration: "none", color: "#4b5563"}}>{localData.email}</a>
                  )}
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  {editMode ? (
                    ...
                    <a href={normalizeUrl(localData.linkedin)} target="_blank" rel="noreferrer" style={{textDecoration: "none", color: "#4b5563"}}>LinkedIn</a>
                  )}
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  {editMode ? (
                    ...
                    <a href={normalizeUrl(localData.github)} target="_blank" rel="noreferrer" style={{textDecoration: "none", color: "#4b5563"}}>GitHub</a>
                  )}
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  {editMode ? (
                    ...
                    <a href={normalizeUrl(localData.portfolio)} target="_blank" rel="noreferrer" style={{textDecoration: "none", color: "#4b5563"}}>Portfolio</a>
                  )}
                </div>
              </div>
            </div>
